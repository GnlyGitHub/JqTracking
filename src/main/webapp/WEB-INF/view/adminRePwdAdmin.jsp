            ...
            <div class="layui-form" style="width: 550px;">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input id="oldPwd" type="password" name="oldPwd" required lay-verify="required"
                               placeholder="请输入原密码" autocomplete="off" class="layui-input">
                    </div>
                    <p id="oldPwdP" style="color: red; display: none; position: relative;top: 9px;font-size: 14px">
                        请输入原密码</p>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input id="newPwd" type="password" name="newPwd" required lay-verify="required"
                               placeholder="请输入新密码" autocomplete="off" class="layui-input">
                    </div>
                    <p id="newPwdP1" style="color: red; display: none; position: relative;top: 9px;font-size: 14px">
                        请输入新密码</p>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input id="repPwd" type="password" name="repPwd" required lay-verify="required"
                               placeholder="请输入新密码" autocomplete="off" class="layui-input">
                    </div>
                    <p id="repPwdP1" style="color: red; display: none; position: relative;top: 9px;font-size: 14px">
                        请输入新密码</p>
                    <p id="repPwdP2" style="color: red; display: none; font-size: 14px">密码由字母、数字组成，长度为6~18位</p>
                    <p id="repPwdP3" style="color: red; display: none; position: relative;top: 9px;font-size: 14px">
                        两次密码不一致</p>
                </div>
